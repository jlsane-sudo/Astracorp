...
export const TUTORIAL_STEPS = [
  ...
  },
  {
    ...
    desc: 'Tu primer objetivo industrial es automatizar agua. No intentes abrir todos los sistemas de golpe.',
  ...
  },
  {
    ...
    desc: 'Antes de diversificar, consolida la base. El nivel 2 te abre el siguiente escalon sin saturarte.',
  ...
  {
    id: 'buy_once',
    title: 'Haz tu primer intercambio',
    desc: 'Cuando ya tienes base y nivel 2, entra al mercado para aprender a comprar o vender con criterio.',
